<template>
  <div>
    ...
    <clear-completed :showClearCompletedButton="showClearCompletedButton"></clear-completed>
  </div>
</template>
...
<script>
  ...
  export default {
    name: 'todo-list',
    components: { ClearCompleted, TodoFilter, TodoCheckAll, TodoItem, RemainingTodos },
    data() {
      return {
        newTodo: '',
        idForTodo: 4,
